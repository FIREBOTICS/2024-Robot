...
public class SwerveDrive extends SubsystemBase {
     ...
     * <p>
     * Sets the drive power of each module to zero while maintaining module
     * headings.
     */
    public void stop() {
     ...
     * <p>
     * Uses PID and feedforward control (closed-loop) to control the linear and
     * rotational values for the modules.
     * 
    ...
    public SwerveModuleState[] getModuleStates() {
        return new SwerveModuleState[] {
                new SwerveModuleState(frontLeftMod.getCurrentVelocityMetersPerSecond(),
                        frontLeftMod.getSteerEncAngle()),
                new SwerveModuleState(frontRightMod.getCurrentVelocityMetersPerSecond(),
     ...
     * 
     * @param driveX          The desired forward/backward lateral motion, in meters
     *                        per second.
     * @param driveY          The desired left/right lateral motion, in meters per
     *                        second.
    ...
    public void drive(double driveX, double driveY, double rotation, boolean isFieldRelative) {
        ...
        if (isLocked) {
            ...
            ChassisSpeeds speeds = isFieldRelative
                    ...
                    : new ChassisSpeeds(driveX, driveY, rotation); // If you put - on rotation it the wheels goes
                                                                   // backwards not the angle

            // Uses kinematics (wheel placements) to convert overall robot state to array of
            // individual module states.
            SwerveModuleState[] states = DriveConstants.kinematics.toSwerveModuleStates(speeds);

            // Makes sure the wheels don't try to spin faster than the maximum speed
            // possible
     ...
     * 
     * <p>
     * SwerveCmd contains 4 {@link SwerveModule}, a gyro, and methods to control the
     * drive base and odometry.
     */
    public SwerveDrive() {
        // Resets the measured distance driven for each module
        // resetDriveDistances();
    ...
    public void periodic() {
        ...
        if (speedChanged)
            ...
            speedFactor = Preferences.getDouble(speedFactorKey, speedFactor);
    }
